...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = 1373496192L;

    public static final QMember member = new QMember("member1");

    public final myCloset.restfullApi.entity.common.QEntityDate _super = new myCloset.restfullApi.entity.common.QEntityDate(this);
